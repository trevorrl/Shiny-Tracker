ScreenResources{
	...
	StreamerScreen = {
		...
		ButtonEdit = "Edit",
		LabelResetsCount = "Reset Count",
		LabelWelcomeMessage = "Welcome Message",
		LabelFavorites = "Favorite Pokémon",
		OptionDisplayFavorites = "Show on new game screen",
		PromptEditResetsTitle = "Edit Reset Counter",
		PromptEditResetsDesc = "Enter the existing number of resets",
	...
	MGBACommands = {
		...
		CreditsDesc = "Displays a list of team members who helped contribute to creating the Shiny Tracker.",
		...
		ResetsDesc = "Allows you to manually change the Reset counter to a different number",
		ResetsError1 = "Where # is a positive number.",
		ResetsSuccess = "Updating Reset Counter",
